    ...
    public boolean montoBono(){
       ...
       int bono=0;
        ...
        try {
            ...
            while(rs.next()){
                Empleado tata=new Empleado();
                tata.setRut(rs.getString("rut"));
                tata.setNombre(rs.getString("nombre"));
                tata.setEdad(rs.getInt("edad"));
                tata.setAntiguedad(rs.getInt("antiguedad"));
                int asd=tata.getAntiguedad()*50000;
                tata.setBono(asd);
                lista.add(tata);                
            }
